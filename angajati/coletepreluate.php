...
<font face="Trebuchet MS" size="7" color="white"><b><span class="fa fa-archive"></span> COMENZI PRELUATE</b></font><hr>
<table id="comenzi">
  <tr>
...
<?php
$query = 'CALL ComenziPreluate_Colectori(' . $_SESSION['AngajatID'] . ');';
...
?>
  <tr>
	...
	<td>
	<?php if($user['Status'] == 3) echo '<a href="actiunicolectori.php?action=2&angajatid='. $_SESSION['AngajatID'] .'&coletid=' . $user['ColetID'] . '"><b><font color="green" size="4"><span class="fa fa-check"></span> Ridicare colet</font></b></a><br>';
			else echo '<a href="actiunicolectori.php?action=3&angajatid='. $_SESSION['AngajatID'] .'&coletid=' . $user['ColetID'] . '"><b><font color="green" size="4"><span class="fa fa-check"></span> Coletul a ajuns la sediu</font></b></a><br>';
	?>
	</td>
  </tr>
<?php } ?>
...
<font face="Trebuchet MS" size="7" color="white"><b><span class="fa fa-archive"></span> COMENZI ADUSE LA SEDIUL DIN ORASUL EXPEDITORULUI</b></font><hr>
<table id="comenzi">
  <tr>
    <th style="text-align:center;">ID Colet</th>
	<th style="text-align:center;">Volum</th>
...
<?php
$query = 'CALL ComenziFinalizate_Colectori(' . $_SESSION['AngajatID'] . ');';
$res = mysqli_query($DB, $query);
mysqli_next_result($DB);
while($user = mysqli_fetch_array($res)){
?>

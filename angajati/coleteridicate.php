...
<font face="Trebuchet MS" size="7" color="white"><b><span class="fa fa-archive"></span> COMENZI RIDICATE</b></font><hr>
<table id="comenzi">
  <tr>
...
<?php
$query = 'CALL ComenziRidicate_Livratori(' . $_SESSION['AngajatID'] . ');';
...
?>
  <tr>
	...
	<td>
	<?php echo '<a href="actiunilivratori.php?action=2&angajatid='. $_SESSION['AngajatID'] .'&coletid=' . $user['ColetID'] . '"><b><font color="green" size="4"><span class="fa fa-check"></span> Finalizare comanda</font></b></a><br>'; ?>
	</td>
  </tr>
<?php } ?>
</table>

<font face="Trebuchet MS" size="7" color="white"><b><span class="fa fa-archive"></span> COMENZI FINALIZATE</b></font><hr>
<table id="comenzi">
  <tr>
    <th style="text-align:center;">ID Colet</th>
	<th style="text-align:center;">Volum</th>
...
<?php
$query = 'CALL ComenziFinalizate_Livratori(' . $_SESSION['AngajatID'] . ');';
$res = mysqli_query($DB, $query);
mysqli_next_result($DB);
while($user = mysqli_fetch_array($res)){
?>
